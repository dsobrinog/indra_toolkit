...
namespace indra_toolkit
{
    ...
    class TableWidget : public Widget
    {
        public:
            ...
            inline void SetCenterHeaders(bool center) { center_headers = center; }
            inline void SetCenterCells(bool center) { center_cells = center; }
        ...
        protected:
            ...
            bool show_title;
            bool show_headers;
            bool center_headers = false;
            bool center_cells = false;
